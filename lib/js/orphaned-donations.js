jQuery( function($){
	...
	var table = $('#orphaned-donations').DataTable({
		...
		columnDefs: [
			{ name: 'store_name', data: 'store_name', orderable: false, targets: 0 },
			{ name: 'zipcode', data: 'zipcode', className: 'dt-body-right', orderable: false, targets: 1 },
			{ name: 'website', data: 'website', orderable: false, targets: 2 },
			{ name: 'email_address', data: 'email_address', orderable: false, targets: 3 },
			{ name: 'receive_emails', data: 'receive_emails', orderable: false, targets: 4 },
			{ name: 'total_donations', data: 'total_donations', className: 'dt-body-right', type: 'num', targets: 5 }
		]
	});
