...
jQuery(document).ready(function($){
	...
	// add current month's `Donations by Org` to table:
	getOrgs();
...
var getOrgs = function(month){
	...
	jQuery('#donation-display tbody').html('<tr class="loading"><td colspan="5"><div class="progress"><span class="bar"></span><span class="percent"></span></div></td></tr>');
